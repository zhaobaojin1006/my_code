...
int server_login_send (int sock_fd, char user_name[NAMEMAX], char user_ID[IDMAX])
{
    ...
    while(online_list_ptemp != NULL) {
        ...
        printf ("user_ID:%s,suer_DATA:%s\n",online_list_ptemp -> user_ID, buf) ;
